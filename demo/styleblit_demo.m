function styleblit_demo(style_id, target_frame, sigma, k, density)
    %STYLEBILT_DEMO Cluster-based StyleBlit demo
    %   
    % Inputs:
    ...
    %% Figure plot
    fig = figure('Name','Cluster-Based StyleBlit','NumberTitle','off');
    ...
    %% Save figure
    saveas(fig,sprintf('results/styleblit_%s.png', style_id));
