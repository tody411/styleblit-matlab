function styleblit_video_demo(style_id,sigma, k, density)
    % STYLEBLIT_VIDEO_DEMO Cluster-based StyleBlit demo on video inputs.
    %
    % Inputs:
    ...
    video_writer = VideoWriter(sprintf('results/styleblit_%s.mp4', style_id), 'MPEG-4');
